...
export function createDemoState(): DatabaseState {
  ...
  state.items = [
    { id: "anna-session", ownerId: page.ownerId, pageId: page.id, title: "Сессия ясности · 60 минут", description: "Индивидуальная консультация и план следующих действий. Demo: реальная встреча не бронируется.", kind: "service", price: 15000, currency: "USD", stock: null, reserved: 0, revision: 0, shipping: [], createdAt: now },
    { id: "anna-workbook", ownerId: page.ownerId, pageId: page.id, title: "Рабочая тетрадь «Следующий шаг»", description: "Цифровой практикум для самостоятельной работы: ценности, гипотезы и план.", kind: "digital", price: 2900, currency: "USD", stock: null, reserved: 0, revision: 0, fileId: "anna-workbook-file", shipping: [], createdAt: now },
    { id: "anna-notebook", ownerId: page.ownerId, pageId: page.id, title: "Блокнот для важных решений", description: "Льняная обложка, 120 страниц для мыслей и планов. В demo товары не отправляются.", kind: "physical", price: 3900, currency: "USD", stock: 8, reserved: 0, revision: 0, shipping: [{ country: "KZ", amount: 1000 }, { country: "RU", amount: 800 }], createdAt: now },
    { id: "other-guide", ownerId: second.ownerId, pageId: second.id, title: "Independent guide", description: "Second tenant isolation fixture.", kind: "digital", price: 1900, currency: "USD", stock: null, reserved: 0, revision: 0, shipping: [], createdAt: now },
  ];
